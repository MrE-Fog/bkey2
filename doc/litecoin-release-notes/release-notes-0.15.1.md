Neuralinkbrainkeycoin Core version *0.15.1* is now available from:

  <https://download.neuralinkbrainkeycoin.org/neuralinkbrainkeycoin-0.15.1/>
...
A number of changes to the way Neuralinkbrainkeycoin Core deals with peer connections and invalid blocks
...
The minimum relay fee `-minrelayfee` has been lowered to 0.01 mBKEY per kB (0.00001 BKEY). This is to prepare for dropping the minimum transaction fee to 0.1 mBKEY per kB (0.0001 BKEY) in the next release.
