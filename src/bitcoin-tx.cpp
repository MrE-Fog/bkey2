...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " neuralinkbrainkeycoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  neuralinkbrainkeycoin-tx [options] <hex-tx> [commands]  Update hex-encoded neuralinkbrainkeycoin transaction\n" +
            "or:     neuralinkbrainkeycoin-tx [options] -create [commands]   Create hex-encoded neuralinkbrainkeycoin transaction\n" +
            "\n";
