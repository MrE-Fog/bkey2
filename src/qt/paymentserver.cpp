...
const QString BITCOIN_IPC_PREFIX("neuralinkbrainkeycoin:");
// BIP70 payment protocol messages
const char* BIP70_MESSAGE_PAYMENTACK = "PaymentACK";
const char* BIP70_MESSAGE_PAYMENTREQUEST = "PaymentRequest";
// BIP71 payment protocol media types
const char* BIP71_MIMETYPE_PAYMENT = "application/neuralinkbrainkeycoin-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/neuralinkbrainkeycoin-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/neuralinkbrainkeycoin-paymentrequest";
...
{
    QString name("NeuralinkbrainkeycoinQt");
    ...
    if (startLocalServer)
    {
        ...
        if (!uriServer->listen(name)) {
            ...
            QMessageBox::critical(0, tr("Payment request error"),
                tr("Cannot start neuralinkbrainkeycoin: click-to-pay handler"));
        }
        else {
...
void PaymentServer::handleURIOrFile(const QString& s)
{
    ...
    if (s.startsWith("neuralinkbrainkeycoin://", Qt::CaseInsensitive))
    {
        Q_EMIT message(tr("URI handling"), tr("'neuralinkbrainkeycoin://' is not a valid URI. Use 'neuralinkbrainkeycoin:' instead."),
    ...
    else if (s.startsWith(BITCOIN_IPC_PREFIX, Qt::CaseInsensitive)) // bitcoin: URI
    {
        ...
        else // normal URI
        {
            ...
            if (GUIUtil::parseBitcoinURI(s, &recipient))
            {
                ...
                Q_EMIT message(tr("URI handling"),
                    tr("URI cannot be parsed! This can be caused by an invalid Neuralinkbrainkeycoin address or malformed URI parameters."),
                    CClientUIInterface::ICON_WARNING);
