...
void Shutdown()
{
    ...
    RenameThread("neuralinkbrainkeycoin-shutoff");
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/neuralinkbrainkeycoin-project/neuralinkbrainkeycoin>";
    const std::string URL_WEBSITE = "<https://neuralinkbrainkeycoin.org>";
...
static void ThreadImport(std::vector<fs::path> vImportFiles)
{
    ...
    RenameThread("neuralinkbrainkeycoin-loadblk");
...
bool AppInitMain()
{
    ...
    if (gArgs.IsArgSet("-datadir") && !fs::path(gArgs.GetArg("-datadir", "")).is_absolute()) {
        LogPrintf("Warning: relative datadir option '%s' specified, which will be interpreted relative to the " /* Continued */
                  "current working directory '%s'. This is fragile, because if neuralinkbrainkeycoin is started in the future "
                  "from a different location, it will be unable to locate the current data files. There could "
                  "also be data loss if neuralinkbrainkeycoin is started while in a temporary directory.\n",
